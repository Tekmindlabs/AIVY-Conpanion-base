...
async def get_memory_by_id(self, memory_id: str) -> Dict:
    """Get a specific memory with all its details"""
    try:
        ...
        graph_result = self.graph.query(graph_query, {"memory_id": memory_id})
        
        memory["entities"] = graph_result[0]["entities"] if graph_result else []
